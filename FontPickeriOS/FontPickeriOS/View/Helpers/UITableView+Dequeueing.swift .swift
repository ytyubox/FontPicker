...
extension UITableView {
    ...
    func dequeueReusableCell<Cell: ReusableCell>(with _: Cell.Type) -> Cell {
        dequeueReusableCell(withIdentifier: Cell.id) as! Cell
    }

    func dequeueReusableCell<Cell: ReusableCell>(with _: Cell.Type, for indexPath: IndexPath) -> Cell {
        dequeueReusableCell(withIdentifier: Cell.id, for: indexPath) as! Cell
    }

    func register<Cell: ReusableCell>(_: Cell.Type) {
